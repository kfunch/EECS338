...
def bagOfWordsGivenParagraphs(cleanParagraphArr, top2):
	...
	s = ['the', 'of', 'a', 'an', 'and', 'to', 'that', 'in', 'is', 'as', 'for', 'it', 'with', 'on', 'was', 'be', 'at',
		 ...
		 'so', 'them', 'then', 'than', 'into', 'been', 'over', 'more', 'will', 'can', 'this', 'there', 'your']
	...
	problem = problem + top2
	personalStory = personalStory + top2
	solution = solution + top2
...
def main():
	...
	top2 = sys.argv[2]
	bagOfWordsGivenParagraphs(cleanParagraphArr, top2)
